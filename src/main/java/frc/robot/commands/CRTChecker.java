...
public class CRTChecker extends Command {
  ...
  public void execute() 
  {
    crt.getAngleOptional().ifPresentOrElse(angle -> {SmartDashboard.putNumber("Commands/CRT/Angle", angle.in(Degrees));}, () -> {SmartDashboard.putNumber("Commands/CRT/Angle", -1.0);});
